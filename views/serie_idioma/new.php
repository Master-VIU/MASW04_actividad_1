<div>
    ...
    <div class="table_container">
        <ul class="items_table">
            ...
            $idSerie = $_GET['id'];
            $sendData = false;
            $serieIdiomaVinculado = false;
            if (isset($_POST['botonVincular'])) {
                $sendData = true;
            }
            if ($sendData) {
                if (isset($_POST['idiomaId']) && isset($_POST['idiomaTipo'])) {
                    $serieIdiomaVinculado = crearSerieIdioma($idSerie, $_POST['idiomaId'], $_POST['idiomaTipo']);
                }

                if ($serieIdiomaVinculado) {
                    ?>
            ...
            <form name="nuevo_serieIdioma" action="" method="POST">
        ...
        <?php
            ...
            <div class="alerta alerta-warning" role="alert">
                Esta vista se ha abierto incorrectamente. Para acceder, primero entre en "Series", "Idiomas" y en
                "Vincular".
            </div>
            <?php
        }
