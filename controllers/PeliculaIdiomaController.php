...
function listarPeliculaIdiomasTipo($idPelicula, $tipo)
{
...
function listarPeliculaIdiomasAll($idPelicula)
{
    $model = new PeliculaIdioma($idPelicula, null, null);
...
function listarPeliculasDeIdioma($idIdioma)
{
    $model = new PeliculaIdioma(null, $idIdioma, null);
    $listaPeliculasDeIdioma = $model->getAllPeliculas();
    return $listaPeliculasDeIdioma;
}
